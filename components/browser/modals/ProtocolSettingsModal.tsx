...
const PROTOCOL_ORDER: ProtocolType[] = ['standard', 'allowlist', 'protected', 'harness', 'holographic', 'gpt52'];
      ...
      <View style={styles.overlay}>
        <View style={styles.content}>
          ...
          <ScrollView style={styles.body} showsVerticalScrollIndicator={false}>
            ...
            {/* Holographic */}
            <TouchableOpacity style={styles.expandHeader} onPress={() => toggleExpanded('holographic')}>
              <Text style={styles.expandTitle}>Holographic Stream</Text>
              <ChevronRight size={18} color="rgba(255,255,255,0.5)" style={{ transform: [{ rotate: expanded === 'holographic' ? '90deg' : '0deg' }] }} />
            </TouchableOpacity>
            {expanded === 'holographic' && (
              <View style={styles.card}>
                <View style={styles.settingRow}>
                  ...
                  <Switch
                    ...
                    disabled={!isProtocolEditable}
                    trackColor={{ false: 'rgba(255,255,255,0.2)', true: '#00ff88' }}
                    thumbColor={holographicSettings.useWebSocketBridge ? '#ffffff' : '#888888'}
                  />
                </View>
                    ...
                    {(['720p', '1080p', '4k'] as const).map((res) => (
                      <TouchableOpacity
                        ...
                        style={[
                          ...
                          !isProtocolEditable && styles.sensitivityBtnDisabled,
                        ]}
                ...
                <View style={styles.settingRow}>
                  ...
                  <Switch
                    ...
                    thumbColor={holographicSettings.sdpMasquerade ? '#ffffff' : '#888888'}
                  />
                </View>
