...
async function main() {
  ...
  const protocolRuns: ProtocolRun[] = [
    ...
    {
      name: 'Protocol 1: stealth',
      id: 'stealth',
      injectedBeforeLoad: workingInjectionScript,
      postLoadConfig: { ...postLoadConfigBase, protocolId: 'stealth', protocolLabel: 'stealth' },
    },
    {
      name: 'Protocol 2: relay (working injection path)',
      id: 'relay',
      injectedBeforeLoad: workingInjectionScript,
    ...
    {
      name: 'Protocol 5: stealth (media injection fallback)',
      id: 'stealth',
      injectedBeforeLoad: createMediaInjectionScript(DEVICES as any, {
        protocolId: 'stealth',
    ...
    {
      name: 'Protocol 5: stealth (AI-powered)',
      id: 'stealth',
    ...
    },
    {
      ...
      postLoadConfig: { ...postLoadConfigBase, protocolId: 'relay', protocolLabel: 'Protocol 2: Advanced Relay' },
    },
    {
